...
Данная программа была разработанна в Visual Studio в рамках WPF-приложения полностью на языке программирования C#. В этой программе представлены два окна (Registration и LogIn) с полностью готовым функционалом
